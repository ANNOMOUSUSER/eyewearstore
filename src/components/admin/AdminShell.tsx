...
export default function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8">
      <div className="mb-6 flex items-center justify-between gap-4 rounded-[32px] border border-line bg-paper p-4 shadow-card md:p-6">
      ...
      <div className="grid gap-6 md:grid-cols-[240px_1fr]">
        <aside className={`rounded-[24px] border border-line bg-paper p-4 transition-all duration-300 ${open ? "block" : "hidden md:block"}`}>
